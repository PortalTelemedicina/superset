 ...
 * Only the metadata flag is used. The PTM tag is purely organizational and never
 * enables PTM or triggers chart conversion. Chart conversion/reversion happens only
 * through an explicit user toggle (see PropertiesModal -> convert/revert helpers).
 */
