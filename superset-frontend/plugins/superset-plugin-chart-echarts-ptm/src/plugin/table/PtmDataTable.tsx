...
import GlobalFilter, {
  GlobalFilterProps,
} from '../../../../plugin-chart-table/src/DataTable/components/GlobalFilter';
    ...
    >
      ...
      {hasPagination
        ? (() => {
            ...
            const start =
              total === 0 ? 0 : resultCurrentPage * pageSizeValue + 1;
            const end =
              total === 0
                ? 0
            ...
            const width = Math.max(
              7,
              maxPageItemCount % 2 === 0
                ? maxPageItemCount - 1
                : maxPageItemCount,
            );
            const items = generatePageItems(
              resultPageCount,
              resultCurrentPage,
              width,
            );
            ...
            return (
              <div
                ...
                className="ptm-dt-footer"
              >
                <div className="ptm-dt-footer-left">
                  <span className="ptm-dt-page-size-label">
                    Registro por página:
                  </span>
                  <SelectPageSize
                    total={total}
                ...
                <div className="ptm-dt-footer-center">
                  <span className="ptm-dt-range-bold">
                    {start} - {end}
                  </span>
                ...
                <div className="ptm-dt-footer-right">
                  ...
                  <button
                    ...
                    disabled={isFirst}
                    onClick={() =>
                      resultOnPageChange(Math.max(0, resultCurrentPage - 1))
                    }
                  ...
                  <div className="ptm-dt-pages">
                    {items.map(item =>
                      typeof item === 'number' ? (
                        ...
                        <span key={item} className="ptm-dt-ellipsis">
                          …
                        </span>
                      ),
                    )}
                  ...
                  <button
                    ...
                    onClick={() =>
                      resultOnPageChange(
                        Math.min(resultPageCount - 1, resultCurrentPage + 1),
                      )
                    }
