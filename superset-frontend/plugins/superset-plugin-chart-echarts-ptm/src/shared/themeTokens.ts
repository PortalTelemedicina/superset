...
export function getThemeTokens(theme: ThemeLike): ThemeTokens {
  ...
  const gu =
    (t.sizeUnit as number) ?? (t.gridUnit as number) ?? DEFAULT_SIZE_UNIT;
  ...
  return {
    ...
    colorTextSecondary:
      (t.colorTextSecondary as string) ??
      (t.colorTextLabel as string) ??
      colors.base ??
      '#666666',
    colorTextHeading:
      (t.colorTextHeading as string) ??
      (t.colorText as string) ??
      colors.dark2 ??
      '#000000',
    colorTextLabel:
      (t.colorTextLabel as string) ??
    ...
    colorBgLayout:
      (t.colorBgLayout as string) ??
      (t.colorBgContainer as string) ??
      colors.light5 ??
      '#f5f5f5',
    colorBorder:
      (t.colorBorder as string) ?? colors.light2 ?? 'rgba(0,0,0,0.1)',
    colorBorderSecondary:
      (t.colorBorderSecondary as string) ??
      (t.colorBorder as string) ??
      colors.light2 ??
      'rgba(0,0,0,0.06)',
    ...
    colorSuccessText:
      (t.colorSuccessText as string) ?? (t.colorSuccess as string) ?? '#52c41a',
    colorErrorText:
      (t.colorErrorText as string) ?? (t.colorError as string) ?? '#ff4d4f',
    colorSuccessTextActive:
      (t.colorSuccessTextActive as string) ??
      (t.colorSuccess as string) ??
      '#52c41a',
    colorErrorTextActive:
      (t.colorErrorTextActive as string) ??
      (t.colorError as string) ??
      '#ff4d4f',
    colorFillSecondary:
      (t.colorFillSecondary as string) ?? colors.light3 ?? '#f0f0f0',
    colorFillTertiary:
      (t.colorFillTertiary as string) ??
      (t.colorFillSecondary as string) ??
      colors.light4 ??
      '#fafafa',
    fontWeightStrong:
      (t.fontWeightStrong as number) ??
      weights.bold ??
      DEFAULT_FONT_WEIGHT_STRONG,
    borderRadius:
      (t.borderRadius as number) ??
      (t.borderRadiusLG as number) ??
