...
module.exports = {
  ...
  overrides: [
    ...
    {
      // Portal Telemedicina PTM extension — incremental lint cleanup tracked separately
      files: [
        'src/ptm/**/*.{js,jsx,ts,tsx}',
        'plugins/superset-plugin-chart-echarts-ptm/**/*.{js,jsx,ts,tsx}',
      ],
      rules: {
